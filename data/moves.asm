...
MoveEnd:
	...
	move NIGHT_SHADE,  SPECIAL_DAMAGE_EFFECT,        0, GHOST_T,  100, 15
	...
	move CONFUSE_RAY,  CONFUSION_EFFECT,             0, GHOST_T,  100, 10
	...
	move LICK,         PARALYZE_SIDE_EFFECT2,       20, GHOST_T,  100, 30
	...
	move CURSE,        CURSE_EFFECT,                 1, UNKNOWN,  100,  1
